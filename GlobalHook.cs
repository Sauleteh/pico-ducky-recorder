...
namespace PicoDucky
{
    public class GlobalHook
    {
        ...
        {
            mainForm.labelMousePosition.Text = string.Format("x={0:0000}; y={1:0000}", e.X, e.Y);
        }
        ...
        {
            mainForm.labelWheel.Text = string.Format("Wheel={0:000}", e.Delta);
        }

        private void HookManager_MouseHWheel(object sender, MouseEventArgs e)
        {
            mainForm.labelHWheel.Text = string.Format("HWheel={0:000}", e.Delta);
        }
        ...
        private void Log(string text)
        {
            ...
            mainForm.textBoxLog.AppendText(Environment.NewLine);
            mainForm.textBoxLog.ScrollToCaret();
        }
    }
}
